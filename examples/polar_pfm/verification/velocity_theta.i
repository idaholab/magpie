...
E_md = '${fparse E_ss/KE}'
E_mb = '${fparse E_ss/KE}'
Delta_ss = '${units 3e-9 m -> nm}' # length conversion delta^21
...
[Functions]
  [vanalytic]
    type = ParsedFunction
    # value = 'q:=4*${Temp_}^3- 3*${Temp_}^4; dG21:=${G2}-${G1}; dG:=${G1}+dG21*q; 6*${L_theta}*${Delta_ss}*dG/1'
    expression = 'dG21:=${G2}-${G1}; 6*${L_theta}*${Delta_ss}*dG21/${P4}'
  []
[]
...
[Outputs]
  ...
  file_base = 'out/velocity_theta_${KE}_${KD}_${Temp_}'
  csv = true
